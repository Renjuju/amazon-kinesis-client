...
public class AsynchronousGetRecordsRetrievalStrategy implements GetRecordsRetrievalStrategy {
    ...
    public AsynchronousGetRecordsRetrievalStrategy(@NonNull final DataFetcher dataFetcher,
    ...
    public AsynchronousGetRecordsRetrievalStrategy(final DataFetcher dataFetcher,
    ...
    AsynchronousGetRecordsRetrievalStrategy(DataFetcher dataFetcher, ExecutorService executorService,
